...
<div class="panel panel-default">
    <div class="panel-heading">
        <b><i class=" fa fa-university"></i>Department Details</b>
    </div>
    <div class="panel-body" style="padding-bottom:4px;">
        
        <form action="<?php echo e(route('saveDepartment')); ?>" method="post" id="frm-create-student" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<!--  <tr>
   ...
   <tr>
    ...
    <td>  <div>
      <div class="col-md-10">
          <div class="form-group">            
              <input type="text"  name="hod" id="hod" class="form-control" required>
           </div>
        </div>
    </div></td> 
  </tr>
  ...
  <tr>
    ...
    <td>  <div>
      <div class="col-md-10">
          <div class="form-group">    
              <select class="form-control"  name="d" id="d" class="form-control" style="color:black; width: 500px;"required>
                    <option value="">-------------------------------------</option>
                    <?php $__currentLoopData = $degree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($deg->Degree_Name); ?>"><?php echo e($deg->Degree_Name); ?></option>
 ...
 <br>
    ...
    <button value="submit" onclick = "getConfirmation();" class="btn btn-default btn-save">Save Department <i class="fa fa-save"></i></button>
