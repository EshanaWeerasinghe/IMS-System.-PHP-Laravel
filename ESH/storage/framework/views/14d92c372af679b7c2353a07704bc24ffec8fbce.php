...
<div class="row">
    <div class="col-lg-8">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-file-text-o"></i>Edit Assign Course Details</li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <b><i class=" fa fa-university"></i>Edit Assign Course</b>
    </div>
    <div class="panel-body" style="padding-bottom:6px;">
        
        <form action="<?php echo e(route('updateAssignCourse')); ?>" method="post" id="frm-create-student" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<table width="28%" class="table table-hover">  
   ...
   <tr>
    <td>Year :</td>
     <input type="hidden" name ="assignc_id" value="<?php echo e($assign->assignc_id); ?>">
    <td> <div class="col-sm-5">
            <div class="input-group">
                <select class="form-control"  name="year" id="year" class="form-control" style="color:black;" required>
                    <option value="<?php echo e($assign->year); ?>"><?php echo e($assign->year); ?></option>
    ...
    <td>   <div class="col-sm-6">
            <div class="input-group">
                <select class="form-control"  name="semester" id="semester" class="form-control" style="color:black;" required>
                     <option value="<?php echo e($assign->semester); ?>"><?php echo e($assign->semester); ?></option>
   ...
   <tr>
    ...
    <td>   <div class="col-sm-7">
            <div class="input-group">
                ...
                <option value="<?php echo e($assign->Ccode); ?>"><?php echo e($assign->Ccode); ?></option>   
  ...
  <tr>
    ...
    <td>   <div class="col-sm-7">
            <div class="input-group">
                ...
                <option value="<?php echo e($assign->Course); ?>"><?php echo e($assign->Course); ?></option>
                <?php $__currentLoopData = $student_course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cou): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <td>   <div class="col-sm-4">
            <div class="input-group">
                 <select class="form-control" name="Lecturer" id="Lecturer" style="color:black; width: 200px;">
                    <option value="<?php echo e($assign->Lecturer); ?>"><?php echo e($assign->Lecturer); ?></option>
