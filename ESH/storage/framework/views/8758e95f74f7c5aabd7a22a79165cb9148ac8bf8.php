...
<div class="row">
    <div class="col-lg-8">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-file-text-o"></i>Exam Registration</li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <b><i class=" fa fa-university"></i>Exam Registration</b>
    </div>
    <div class="panel-body" style="padding-bottom:6px;">
        
        <form action="<?php echo e(route('checkRegExam')); ?>" method="post" id="frm-create-student" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<tr>
   ...
   <tr>
    ...
    <button value="submit" class="btn btn-default btn-save">Search<i class="fa fa-save"></i></button>
    <br>
    </div>
