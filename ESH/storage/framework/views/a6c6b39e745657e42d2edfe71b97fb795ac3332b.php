  ...
  &nbsp;
   <?php echo Form::open(array('url'=>'insertfile','method'=>'POST','class'=>'form-horizontal','files'=>true)); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control file_title_c" name="file_title" id="file_title_id" placeholder="Enter Title" value="<?php echo e(Input::old('file_title')); ?>">
            
             <?php if($errors->has('file_title')): ?> <p class = "help-block"><?php echo e($errors->first('file_title')); ?></p> 
             <?php endif; ?>
    </div>
    </div>
  &nbsp;
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <?php if($errors->has('filenam')): ?> <p class = "help-block"><?php echo e($errors->first('filenam')); ?></p> 
             <?php endif; ?>
    </div>
    </div>
  &nbsp;
