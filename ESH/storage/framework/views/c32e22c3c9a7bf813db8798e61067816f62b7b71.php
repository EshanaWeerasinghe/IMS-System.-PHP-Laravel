...
<div class="row">
    <div class="col-lg-8">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-file-text-o"></i>Check Hall Availability</li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="padding-bottom:4px;">
        ...
        <form action="<?php echo e(route('checkAvailable')); ?>" method="post" id="frm-create-student" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<tr>
  ...
  <tr>
    ...
    <td>   <div class="col-sm-10">
            <div class="input-group">
                <select class="form-control"  name="course_code" id="course_code" class="form-control" style="color:black;"required>
                    <option value="">------------------</option>
                    <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($t->course_unit); ?>"><?php echo e($t->course_unit); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
 ...
 <br>
    ...
    <button value="submit"  class="btn btn-default btn-save">Check Availability<i class="fa fa-save"></i></button>
