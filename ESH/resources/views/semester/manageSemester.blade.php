...
@section('content')
@include('semester.popup.academic')
@include('semester.popup.program')
@include('semester.popup.level')
@include('semester.popup.shift')
@include('semester.popup.time')
@include('semester.popup.batch')
@include('semester.popup.group')
