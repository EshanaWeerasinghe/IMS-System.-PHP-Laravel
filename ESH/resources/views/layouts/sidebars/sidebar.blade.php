...
<!--Courses-->
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{ route('manageStudentCourse')}}">Manage Course</a></li>
              <li><a class="" href="{{ route('SemesterandCourse')}}">Semester and Course</a></li>
              <li><a class="" href="{{ route('check')}}">Check</a></li>
              <li><a class="" href="{{ route('SemesterCourseList')}}">Combination List</a></li>
              <li><a class="" href="{{ route('manageStudentDegree')}}">Degree</a></li>
              <li><a class="" href="{{ route('DegreeInfo') }}">Degree List</a></li>
              <li><a class="" href="{{ route('CourseInfo') }}">Course List</a></li>
              <li><a class="" href="{{ route('getSubject')}}">Subject</a></li>
              <li><a class="" href="{{ route('subjectList')}}">Subject List</a></li>       
            </ul>
          </li> 
...
<!--Student-->
         <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="{{route('studentInfo')}}">Find Student</a></li>
              <li><a class="" href="{{route('getStudentist')}}">Upload Students List</a></li>
              <li><a class="" href="{{route('getStudentCourses')}}">Edit Student</a></li>
              <li><a class="" href="{{route('Upload2')}}">Upload pdf</a></li>            
              <li><a class="" href="{{route('Upload')}}">Document</a></li>
...
<!--Semester-->
        <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{route('manageSemester')}}">View/Edit</a></li>      
            </ul>
          </li>
...
<!--Departments-->
  <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{route('manageDepartment')}}">Add Departments</a></li>
              <li><a class="" href="{{route('DepartmentList')}}">Department Report</a></li>        
            </ul>
          </li>
...
<!-- Lecture Halls-->
    <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{route('getLectureHall')}}">New Hall</a></li>   
              <li><a class="" href="{{route('hallList')}}">Lecture Halls</a></li>                                
            </ul>
          </li>
@endif
...
<!--Lectures-->
  <li class="sub-menu">
            ...
            <ul class="sub"> 
             <li><a class="" href="{{route('LecturerList')}}">Lecturers List</a></li>
             <li><a class="" href="{{route('getLecturer')}}">New Lecturer</a></li>
             <li><a class="" href="{{route('AssignCourses')}}">Assign Course</a></li>
             <li><a class="" href="{{route('AssignCoursetList')}}">Assign Course List</a></li>                       
            </ul>
  </li>    
...
<!--TimeTable-->
  <li class="sub-menu">
            ...
            <ul class="sub">
             <li><a class="" href="{{route('getTimetableList')}}">Time Table</a></li>
              <li><a class="" href="{{route('getAvailability')}}">Lecture Hall Availability</a></li>
@if(!Auth::guest() && Auth::user()->hasRole(['admin']))  
              <li><a class="" href="{{route('getTimetable')}}">Insert Time Table</a></li>
@endif          
            </ul>
  </li> 
...
<!--Exams-->
  ...
  <li class="sub-menu">
            ...
            <ul class="sub">
             <li><a class="" href="{{route('checkExam')}}">Exam Registration</a></li>
             <li><a class="" href="grids.html">Exam Schedule</a></li> 
             <li><a class="" href="grids.html">Student Course Marks </a></li>
             <li><a class="" href="{{route('getImport')}}">Upload Mark Sheet </a></li>
             <li><a class="" href="{{route('getMarkList')}}">Get Marks Report</a></li>
             ...
             <li><a class="" href="{{route('getstuinsert')}}">Test</a></li>
            </ul>
          </li> 
        @endif 
...
<li class="sub-menu">
    ...
    <ul class="sub">        
        <li><a class="" href="{{ route('getStudentListMultiClass') }}">Student List</a></li> 
