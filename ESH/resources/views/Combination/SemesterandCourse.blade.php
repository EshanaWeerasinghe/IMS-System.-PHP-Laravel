...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="padding-bottom:6px;">
        ...
        <form action="{{route('saveSem')}}" method="post" id="frm-create-student" enctype="multipart/form-data">
            {!!csrf_field()!!}
    ...
    <td>   <div class="col-sm-10">
            <div class="input-group">
                <select class="form-control" name="course_code" id="course_code">
                    <option value="">----------</option>
                        @foreach($course as $key => $p)
                        <option value="{{$p->course_unit}}">{{$p->course_unit}}</option>
                        @endforeach  
                </select>            
             </div>
           </div>        
