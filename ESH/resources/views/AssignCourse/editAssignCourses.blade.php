...
<div class="panel panel-default">
    ...
    <div class="panel-body" style="padding-bottom:6px;">
        ...
        <form action="{{route('updateAssignCourse')}}" method="post" id="frm-create-student" enctype="multipart/form-data">
            {!!csrf_field()!!}
    ...
    <td>   <div class="col-sm-6">
            <div class="input-group">
                <select class="form-control"  name="semester" id="semester" class="form-control" style="color:black;" required>
                     <option value="{{$assign->semester}}">{{$assign->semester}}</option>
   ...
   <tr>
    ...
    <td>   <div class="col-sm-7">
            <div class="input-group">
                ...
                <option value="{{$assign->Ccode}}">{{$assign->Ccode}}</option>   
    ...
    <td>   <div class="col-sm-4">
            <div class="input-group">
                 <select class="form-control" name="Lecturer" id="Lecturer" style="color:black; width: 200px;">
                    <option value="{{$assign->Lecturer}}">{{$assign->Lecturer}}</option>
